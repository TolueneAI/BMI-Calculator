package com.gideon.bmicalculator
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val calcButton = findViewById<Button>(R.id.buttonCalculate)
    ...
    private fun displayResult(bmi: Float) {
        ...
        val resultDescription = findViewById<TextView>(R.id.textViewResult)
        val resultInfo = findViewById<TextView>(R.id.textViewInfo)
